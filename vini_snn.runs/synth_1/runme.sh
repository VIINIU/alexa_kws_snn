...
HD_PWD='C:/vini_dir/vini_snn/vini_snn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_snn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_snn.tcl
