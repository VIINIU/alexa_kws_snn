...
HD_PWD='C:/vini_dir/vini_snn/vini_snn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_snn.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_snn.tcl -notrace
